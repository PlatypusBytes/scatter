...
class Test1DWavePropagation_3D(unittest.TestCase):
    ...
    def test_1d_heaviside_wave_tetra10(self):
        sett = {"gamma": 0.5,
                "beta": 0.25,
                "int_order": 2,
                "damping": [1, 0.01, 30, 0.01],
        ...
        load = {"force": [0, -1000, 0],
                "node": [3, 4, 7, 8,51,52,53,135,136,137,183,184,185,186,187,188,432,433,434,435,436,437,438,439,440],
                "time": 1,
                "type": "heaviside",  # pulse or heaviside or moving
                "speed": 80}  # only for moving
        load["force"][1] = load["force"][1]/len(load["node"])
        ...
        # run scatter
        input_file = r"integration_tests/mesh/column_3D_tetra10.msh"
        output_dir = r"integration_tests/results_tetra10"
        scatter(input_file, output_dir, mat, BC, sett, load, time_step=0.5e-3)
